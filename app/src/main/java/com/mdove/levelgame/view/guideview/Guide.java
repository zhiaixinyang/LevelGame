...
/**
 * 遮罩系统的封装 <br>
 * 外部需要调用{@link com.mdove.levelgame.view.guideview.GuideBuilder}来创建该实例，实例创建后调用
...
public class Guide implements View.OnKeyListener, View.OnClickListener {
   ...
   *
   * @see com.mdove.levelgame.view.guideview.GuideBuilder
   */
  Guide() {
  }
  ...
  /**
   * 显示该遮罩, <br>
   * 外部借助{@link com.mdove.levelgame.view.guideview.GuideBuilder}
