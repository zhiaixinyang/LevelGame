...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig myWeaponsDaoConfig;
    ...
    private final MyWeaponsDao myWeaponsDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        myWeaponsDaoConfig = daoConfigMap.get(MyWeaponsDao.class).clone();
        myWeaponsDaoConfig.initIdentityScope(type);
        ...
        myWeaponsDao = new MyWeaponsDao(myWeaponsDaoConfig, this);
        ...
        registerDao(MyWeapons.class, myWeaponsDao);
    }
    ...
    public void clear() {
        ...
        myWeaponsDaoConfig.clearIdentityScope();
    }
    ...
    public MyWeaponsDao getMyWeaponsDao() {
        return myWeaponsDao;
    }
