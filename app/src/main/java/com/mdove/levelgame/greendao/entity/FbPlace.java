...
public class FbPlace {
    ...
    @Generated(hash = 669613874)
    public FbPlace(Long id, String name, String tips, String type, int isLimitCount,
            int limitCount, int curCount, int consumePower, long fbPlaceId) {
        this.id = id;
        this.name = name;
        this.tips = tips;
        this.type = type;
