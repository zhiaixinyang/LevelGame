...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig fBDaoConfig;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        fBDaoConfig = daoConfigMap.get(FBDao.class).clone();
        fBDaoConfig.initIdentityScope(type);
        ...
        fBDao = new FBDao(fBDaoConfig, this);
    ...
    public void clear() {
        ...
        fBDaoConfig.clearIdentityScope();
    }
