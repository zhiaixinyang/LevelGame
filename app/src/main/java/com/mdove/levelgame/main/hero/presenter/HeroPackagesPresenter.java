...
public class HeroPackagesPresenter implements HeroPackagesContract.IHeroPackagesPresenter {
    ...
    private void initEquipData() {
        ...
        // 添加武器占位
        if (equipData.size() == 0) {
            equipData.add(new HasEquipModelVM((long) -1, view.getString(R.string.string_no_hold_on_attack), view.getString(R.string.string_no_hold_on_attack), view.getString(R.string.string_no_hold_on_attack)));
        }
        // 查询装备的防具
        ...
        // 添加防具占位
        if (equipData.size() == 1) {
            equipData.add(new HasEquipModelVM((long) -1, view.getString(R.string.string_no_hold_on_armor), view.getString(R.string.string_no_hold_on_armor), view.getString(R.string.string_no_hold_on_armor)));
        }
                    ...
                    public GoodsTempModel apply(Integer integer) throws Exception {
                        switch (integer) {
                            ...
                            case AllGoodsToDBIdUtils.DB_TYPE_IS_ATTACK: {
                                ...
                                String hasHoldOnType = AppConfig.getHoldWeaponsType();
                            ...
                            case AllGoodsToDBIdUtils.DB_TYPE_IS_ARMOR: {
                                ...
                                String hasHoldOnType = AppConfig.getHoldArmorType();
