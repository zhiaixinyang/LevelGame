...
public class MonstersDao extends AbstractDao<Monsters, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ExpLiLiang = new Property(19, String.class, "expLiLiang", false, "EXP_LI_LIANG");
        public final static Property ExpMinJie = new Property(20, String.class, "expMinJie", false, "EXP_MIN_JIE");
        public final static Property ExpZhiHui = new Property(21, String.class, "expZhiHui", false, "EXP_ZHI_HUI");
        public final static Property ExpQiangZhuang = new Property(22, String.class, "expQiangZhuang", false, "EXP_QIANG_ZHUANG");
    }

    private final IntegerConverter expLiLiangConverter = new IntegerConverter();
    private final IntegerConverter expMinJieConverter = new IntegerConverter();
    private final IntegerConverter expZhiHuiConverter = new IntegerConverter();
    private final IntegerConverter expQiangZhuangConverter = new IntegerConverter();
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MONSTERS\" (" + //
                ...
                "\"EXP_LI_LIANG\" TEXT," + // 19: expLiLiang
                "\"EXP_MIN_JIE\" TEXT," + // 20: expMinJie
                "\"EXP_ZHI_HUI\" TEXT," + // 21: expZhiHui
                "\"EXP_QIANG_ZHUANG\" TEXT);"); // 22: expQiangZhuang
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Monsters entity) {
        ...
        List expLiLiang = entity.getExpLiLiang();
        if (expLiLiang != null) {
            stmt.bindString(20, expLiLiangConverter.convertToDatabaseValue(expLiLiang));
        }
 
        List expMinJie = entity.getExpMinJie();
        if (expMinJie != null) {
            stmt.bindString(21, expMinJieConverter.convertToDatabaseValue(expMinJie));
        }
 
        List expZhiHui = entity.getExpZhiHui();
        if (expZhiHui != null) {
            stmt.bindString(22, expZhiHuiConverter.convertToDatabaseValue(expZhiHui));
        }
 
        List expQiangZhuang = entity.getExpQiangZhuang();
        if (expQiangZhuang != null) {
            stmt.bindString(23, expQiangZhuangConverter.convertToDatabaseValue(expQiangZhuang));
        }
    }
    ...
    public Monsters readEntity(Cursor cursor, int offset) {
        Monsters entity = new Monsters( //
            ...
            cursor.isNull(offset + 19) ? null : expLiLiangConverter.convertToEntityProperty(cursor.getString(offset + 19)), // expLiLiang
            cursor.isNull(offset + 20) ? null : expMinJieConverter.convertToEntityProperty(cursor.getString(offset + 20)), // expMinJie
            cursor.isNull(offset + 21) ? null : expZhiHuiConverter.convertToEntityProperty(cursor.getString(offset + 21)), // expZhiHui
            cursor.isNull(offset + 22) ? null : expQiangZhuangConverter.convertToEntityProperty(cursor.getString(offset + 22)) // expQiangZhuang
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Monsters entity, int offset) {
        ...
        entity.setExpLiLiang(cursor.isNull(offset + 19) ? null : expLiLiangConverter.convertToEntityProperty(cursor.getString(offset + 19)));
        entity.setExpMinJie(cursor.isNull(offset + 20) ? null : expMinJieConverter.convertToEntityProperty(cursor.getString(offset + 20)));
        entity.setExpZhiHui(cursor.isNull(offset + 21) ? null : expZhiHuiConverter.convertToEntityProperty(cursor.getString(offset + 21)));
        entity.setExpQiangZhuang(cursor.isNull(offset + 22) ? null : expQiangZhuangConverter.convertToEntityProperty(cursor.getString(offset + 22)));
     }
